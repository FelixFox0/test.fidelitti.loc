	...
	{	
		...
		foreach ($results as $result) {
			...
			foreach ($types as $type) {
				...
				$newAddress['address'] = !empty($address['address']) ? implode(", ", $address['address']) : "";
				$newAddress['city'] = !empty($address['city']) ? $address['city'] : "";
				$newAddress['country'] = !empty($address['country']) ? $address['country'] : "";
