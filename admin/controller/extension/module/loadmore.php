...
class ControllerExtensionModuleLoadMore extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('mextension/module/loadmore', 'token=' . $this->session->data['token'] . '&type=module', true)
		);

		$data['action'] = $this->url->link('extension/module/loadmore', 'token=' . $this->session->data['token'] . '&type=module', true);
		...
		$this->response->setOutput($this->load->view('extension/module/loadmore.tpl', $data));
	}
