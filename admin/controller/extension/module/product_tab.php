	...
	public function index() {   
		...
		if (!isset($this->request->get['module_id'])) {
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('extension/module/banner', 'token=' . $this->session->data['token'] . '&type=module', true)
			);
		} else {
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('heading_title'),
				'href' => $this->url->link('extension/module/product_tab', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'] . '&type=module', true)
			);			
		}
		
		if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link('extension/module/product_tab', 'token=' . $this->session->data['token'] . '&type=module', true);
		} else {
			$data['action'] = $this->url->link('extension/module/product_tab', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'] . '&type=module', true);
		}
		...
		if($products) foreach ($products as $product_id) {
