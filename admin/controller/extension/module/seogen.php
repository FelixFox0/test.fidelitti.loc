...
class ControllerExtensionModuleSeogen extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/seogen', 'token=' . $this->session->data['token'] . '&type=module', true),
			'separator' => ' :: '
		);

		$data['action'] = $this->url->link('extension/module/seogen', 'token=' . $this->session->data['token'] . '&type=module', true);
		$data['action_profile_add'] = str_replace("&amp;", "&", $this->url->link('module/seogen/profile', 'action=add&token=' . $this->session->data['token'] . '&type=module', true));
		$data['action_profile_get'] = str_replace("&amp;", "&", $this->url->link('module/seogen/profile', 'action=get&token=' . $this->session->data['token'] . '&type=module', true));
		$data['action_profile_del'] = str_replace("&amp;", "&", $this->url->link('module/seogen/profile', 'action=del&token=' . $this->session->data['token'] . '&type=module', true));
		$data['generate'] = $this->url->link('extension/module/seogen/generate', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('extension/module/seogen.tpl', $data));
