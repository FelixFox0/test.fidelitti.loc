...
class ControllerExtensionModuleSmenu extends Controller {
	...
	public function index() {
		...
		$data['button_control_href'] = $this->url->link('extension/extension', 'token=' . $this->session->data['token'] . '&type=module', true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/module/smenu', 'token=' . $this->session->data['token'] . '&type=module', true)
		);

		if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link('extension/module/smenu', 'token=' . $this->session->data['token'] . '&type=module', true);
		} else {
			$data['action'] = $this->url->link('extension/module/smenu', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'] . '&type=module', true);
		}
