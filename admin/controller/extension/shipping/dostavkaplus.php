...
class ControllerExtensionShippingDostavkaPlus extends Controller
{
    ...
    function index()
    {
        ...
        */
        ...
        $this->response->setOutput($this->load->view('/extension/' . $this->type . '/' . $this->name . '.tpl', $data));
    }
    ...
    function license()
    {
        ...
        $data['column_left'] = $this->load->controller('common/column_left');
        $data['footer']      = $this->load->controller('common/footer');
        $this->response->setOutput($this->load->view('/extension/' . $this->type . '/' . $this->name . '_license.tpl', $data));
    }
