...
class ModelModuleDpdDataPaymentTypeSource extends ModelModuleDpdDataSource
{
    const FIXED_AMOUNT = 2;
    const PERCENTAGE_OF_ENTIRE_ORDER = 3;

    public static $_data = array(
        self::FIXED_AMOUNT               => 'Fixed Amount',
        self::PERCENTAGE_OF_ENTIRE_ORDER => 'Percentage of entire order',
    );
