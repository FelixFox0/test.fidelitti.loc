			...
			<div class="tab-content">	
				...
				<div id="language-<?php echo $language['language_id']; ?>" class="tab-pane">
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input name="title[<?php echo $language['language_id']; ?>]" placeholder="<?php echo $entry_title; ?>" id="input-title-<?php echo $language['language_id']; ?>" value="<?php echo isset($title[$language['language_id']]) ? $title[$language['language_id']] : ''; ?>" class="form-control" />
