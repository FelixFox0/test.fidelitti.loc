        ...
        <tr id="city-row<?= $city_row; ?>">
            <td>
                <div class="row">
                    ...
                    <div class="col-md-1 col-xs-3">
                        <input type="text" name="popup_cities[<?= $city_row; ?>][image]" value="<?= $city['image']; ?>" class="form-control"/>
                    </div>
                    <div class="col-md-1 col-xs-3">
                        <input type="text" name="popup_cities[<?= $city_row; ?>][country_ua]" value="<?= $city['country_ua']; ?>" class="form-control"/>
                    </div>
                    <div class="col-md-1 col-xs-3">
                        <input type="text" name="popup_cities[<?= $city_row; ?>][country_ru]" value="<?= $city['country_ru']; ?>" class="form-control"/>
                    </div>
                    <div class="col-xs-2">
...
<script type="text/javascript">
    ...
    function addCity() {
        ...
        html += '<div class="col-md-1 col-xs-3"><input type="text" name="popup_cities[' + city_row + '][image]" value="" class="form-control"/></div>';
         html += '<div class="col-md-1 col-xs-3"><input type="text" name="popup_cities[' + city_row + '][country_ua]" value="" class="form-control"/></div>';
          html += '<div class="col-md-1 col-xs-3"><input type="text" name="popup_cities[' + city_row + '][country_ru]" value="" class="form-control"/></div>';
