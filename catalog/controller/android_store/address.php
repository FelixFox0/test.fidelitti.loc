<?php
class ControllerAndroidStoreAddress extends Controller {
	private $error = array();

	public function index() {
		if (!$this->customer->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('android_store/address', '', true);
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('android_store/address', '', true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('android_store/address', '', true)
		);
		...
		foreach ($results as $result) {
			...
			$data['addresses'][] = array(
				...
				'update'     => $this->url->link('android_store/address/edit', 'address_id=' . $result['address_id'], true),
				'delete'     => $this->url->link('android_store/address/delete', 'address_id=' . $result['address_id'], true)
			);
		}

		$data['add'] = $this->url->link('android_store/address/add', '', true);
		...
		$this->response->setOutput($this->load->view('android_store/address_list', $data));
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['address_id'])) {
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('android_store/address/add', '', true)
			);
		} else {
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('text_edit_address'),
				'href' => $this->url->link('android_store/address/edit', 'address_id=' . $this->request->get['address_id'], true)
			);
		}
		...
		if (!isset($this->request->get['address_id'])) {
			$data['action'] = $this->url->link('android_store/address/add', '', true);
		} else {
			$data['action'] = $this->url->link('android_store/address/edit', 'address_id=' . $this->request->get['address_id'], true);
		}
		...
		$data['back'] = $this->url->link('android_store/address', '', true);
		...
		$this->response->setOutput($this->load->view('android_store/address_form', $data));
	}
