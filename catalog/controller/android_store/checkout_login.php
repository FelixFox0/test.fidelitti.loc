<?php
class ControllerAndroidStoreCheckoutLogin extends Controller {
	public function index() {
		...
		$data['forgotten'] = $this->url->link('android_store/forgotten', '', true);

		$this->response->setOutput($this->load->view('android_store/checkout_login', $data));
	}
