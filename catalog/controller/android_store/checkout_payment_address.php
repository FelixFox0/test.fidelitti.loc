<?php
class ControllerAndroidStoreCheckoutPaymentAddress extends Controller {
	public function index() {
		...
		$this->response->setOutput($this->load->view('android_store/checkout_payment_address', $data));
	}
