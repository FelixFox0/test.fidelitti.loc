<?php
class ControllerAndroidStoreCheckoutShippingAddress extends Controller {
	public function index() {
		...
		$this->response->setOutput($this->load->view('android_store/checkout_shipping_address', $data));
	}
