<?php
class ControllerAndroidStoreCreditCardSagepayDirect extends Controller {
	public function index() {
		...
		if ($this->config->get('sagepay_direct_card')) {
			...
			$data['delete'] = $this->url->link('android_store/credit_card_sagepay_direct/delete', 'card_id=', true);
			...
			$pagination->limit = 10;
			$pagination->url = $this->url->link('android_store/credit_card_sagepay_direct', 'page={page}', true);
		...
		$data['add'] = $this->url->link('android_store/credit_card_sagepay_direct/add', '', true);
		...
		$this->response->setOutput($this->load->view('android_store/credit_card_sagepay_direct_list', $data));
	}
	...
	public function add() {
		...
		$data['back'] = $this->url->link('android_store/credit_card_sagepay_direct', '', true);
		$data['add'] = $this->url->link('android_store/credit_card_sagepay_direct/addCard', '', true);
		...
		$this->response->setOutput($this->load->view('android_store/credit_card_sagepay_direct_form', $data));
	}
	...
	public function delete() {
		...
		$this->response->redirect($this->url->link('android_store/credit_card_sagepay_direct', '', true));
	}
