...
class ControllerCreditCardSagepayServer extends Controller {
	public function index() {
		...
		if ($this->config->get('sagepay_server_card')) {
			...
			$data['delete'] = $this->url->link('android_store/credit_card_sagepay_server/delete', 'card_id=', true);
			...
			$pagination->limit = 10;
			$pagination->url = $this->url->link('android_store/credit_card_sagepay_server', 'page={page}', true);
		...
		$data['add'] = $this->url->link('android_store/credit_card_sagepay_server/add', '', true);
		...
		$this->response->setOutput($this->load->view('android_store/credit_card_sagepay_server_list', $data));
	}
	...
	public function delete() {
		...
		$this->response->redirect($this->url->link('android_store/credit_card_sagepay_server', '', true));
	}
