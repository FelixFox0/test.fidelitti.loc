<?php
class ControllerAndroidStoreEdit extends Controller {
	private $error = array();

	public function index() {
		if (!$this->customer->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('android_store/edit', '', true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('android_store/edit', '', true)
		);
		...
		$data['action'] = $this->url->link('android_store/edit', '', true);
		...
		$this->response->setOutput($this->load->view('android_store/edit', $data));
	}
