<?php
class ControllerAndroidStoreForgotten extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$message .= $this->url->link('android_store/reset', 'code=' . $code, true) . "\n\n";
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('android_store/forgotten', '', true)
		);
		...
		$data['action'] = $this->url->link('android_store/forgotten', '', true);

		$data['back'] = $this->url->link('android_store/login', '', true);
		...
		$this->response->setOutput($this->load->view('android_store/forgotten', $data));
	}
