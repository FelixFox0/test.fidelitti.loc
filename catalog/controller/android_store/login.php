<?php
class ControllerAndroidStoreLogin extends Controller {
	private $error = array();
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('android_store/login', '', true)
		);
		...
		$data['action'] = $this->url->link('android_store/login', '', true);
		...
		$this->response->setOutput($this->load->view('android_store/login', $data));
	}
