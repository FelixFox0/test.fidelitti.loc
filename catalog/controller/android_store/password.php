<?php
class ControllerAndroidStorePassword extends Controller {
	private $error = array();

	public function index() {
		if (!$this->customer->isLogged()) {
			$this->session->data['redirect'] = $this->url->link('android_store/password', '', true);
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('android_store/password', '', true)
		);
		...
		$data['action'] = $this->url->link('android_store/password', '', true);
		...
		$this->response->setOutput($this->load->view('android_store/password', $data));
	}
