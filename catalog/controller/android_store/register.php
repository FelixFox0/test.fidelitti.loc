<?php
class ControllerAndroidStoreRegister extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('android_store/account_success')); 
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('android_store/register', '', true)
		);

		$data['heading_title'] = $this->language->get('heading_title');

		$data['text_account_already'] = sprintf($this->language->get('text_account_already'), $this->url->link('android_store/login', '', true));
		...
		$data['action'] = $this->url->link('android_store/register', '', true);
		...
		$this->response->setOutput($this->load->view('android_store/register', $data));
	}
