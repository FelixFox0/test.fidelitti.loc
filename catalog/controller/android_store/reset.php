<?php
class ControllerAndroidStoreReset extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if ($customer_info) {
			...
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('android_store/reset', '', true)
			);
			...
			$data['action'] = $this->url->link('android_store/reset', 'code=' . $code, true);
			...
			$this->response->setOutput($this->load->view('android_store/reset', $data));
		} else {
			$this->load->language('account/reset');

			$this->session->data['error'] = $this->language->get('error_code');

			return new Action('android_store/login');
		}
	}
