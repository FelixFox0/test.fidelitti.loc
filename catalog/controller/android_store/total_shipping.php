<?php
class ControllerAndroidStoreTotalShipping extends Controller {
	public function index() {
		if ($this->config->get('shipping_status') && $this->config->get('shipping_estimator') && $this->cart->hasShipping()) {
			...
			return $this->load->view('android_store/total_shipping', $data);
		}
	}
	...
	public function quote() {
		...
		if (!$json) {
			...
			if ($this->session->data['shipping_methods']) {
				...
				$json['error']['warning'] = sprintf($this->language->get('error_no_shipping'), $this->url->link('android_store/contact'));
			}
		}
