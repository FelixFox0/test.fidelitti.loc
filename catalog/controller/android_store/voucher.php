<?php
class ControllerAndroidStoreVoucher extends Controller {
	private $error = array();
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link('android_store/voucher/success'));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('android_store/voucher', '', true)
		);
		...
		$data['action'] = $this->url->link('android_store/voucher', '', true);
		...
		$this->response->setOutput($this->load->view('android_store/voucher', $data));
	}
	...
	public function success() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('android_store/voucher')
		);
