...
class ControllerQuickCheckoutCart extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . 'quickcheckout/cart.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/quickcheckout/cart.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('quickcheckout/cart.tpl', $data));
		}	
	}
