...
class ControllerQuickCheckoutTerms extends Controller {
  	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . 'quickcheckout/terms.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . 'quickcheckout/terms.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('quickcheckout/terms.tpl', $data));
		}
	}
