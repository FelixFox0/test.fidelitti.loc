...
// Text
$_['text_success']             = '<div class="alert__title">Добавлено в корзину</div><div class="alert__desc">Товар <a href="%s">%s</a> добавлен в вашу <a href="%s">корзину</a>!</div><div class="alert__button"><a href="/">Продолжить покупки</a><a href="/simplecheckout/">оформить заказ</a></div>';
...
$_['button_gotoshopping']      = 'Продолжить покупки';
$_['text_day']                 = 'день';
$_['text_week']                = 'неделя';
