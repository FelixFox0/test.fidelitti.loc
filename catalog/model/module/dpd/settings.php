...
class ModelModuleDpdSettings extends Model
{
    ...
    //this array it is uesd to save determine
    //which data will be saved in database without checking the data format and type
        ...
        if (is_array($data)) {
            ...
            if ($this->isValid($data)) {
                ...
                if (is_array($stores)) {
                    ...
                    $data          = array_merge($savedSettings, $data);
                    $this->model_setting_setting->editSetting($path, $data, $stores);
                }
    ...
    {
        return $this->getShippingSettings('dpd_services', $storeId);
    }
