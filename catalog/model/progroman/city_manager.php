<?php
    class ModelProgromanCityManager extends Model {
        public function getCities() {
            return $this->db->query("SELECT * FROM prmn_cm_city ORDER BY sort, image, name")->rows;
        }
        ...
        public function getRedirects($fias_ids = []) {
            if (!$fias_ids) {
                return [];
            }

            return $this->db->query("SELECT * FROM prmn_cm_redirect WHERE fias_id IN (" . implode(',', $fias_ids) . ")")->rows;
        }
