        ...
        addCross: function($obj) {
            ...
            $('input[data-filterid='+fid+']').each(function(){
                ...
                if($obj[0].checked) { 
					...
					var label = $('label[for='+fid+'_56]').text();
					
					$('#filter-list').append('<label for="'+fid+'_56">'+label+'<span class="bf-cross"></span></label>');
					$('#button-list-reset').html('<input type="reset" style="z-index:1000;" onclick="BrainyFilter.reset();return false;" value="Сбросить фильтр" />');
