<div class="row">
  <div class="col-sm-6">
    <fieldset id="account">
      <div class="heading-title m-bottom-10"><span><?php echo $text_your_details; ?></span></div>
    ...
    <fieldset>
      <div class="heading-title m-bottom-10"><span><?php echo $text_your_password; ?></span></div>
      <div class="form-group required">
  ...
  <div class="col-sm-6">
    <fieldset id="address">
      <div class="heading-title m-bottom-10"><span><?php echo $text_your_address; ?></span></div>
      <div class="form-group">
...
$('#collapse-payment-address input[name=\'customer_group_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=android_store/checkout/customfield&customer_group_id=' + this.value,
		dataType: 'json',
...
$('#collapse-payment-address select[name=\'country_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=android_store/checkout/country&country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
