...
<div class="container top-extra-space bottom-extra-space">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="heading-title no-border-bottom"><span><?php echo $text_location; ?></span></div>
      ...
      <?php if ($locations) { ?>
      <div class="heading-title no-border-bottom"><span><?php echo $text_store; ?></span></div>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          <div class="heading-title no-border-bottom"><span><?php echo $text_contact; ?></span></div>
