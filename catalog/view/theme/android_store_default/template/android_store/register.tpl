  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset id="account">
			<div class="heading-title no-border-bottom"><span><?php echo $text_your_details; ?></span></div>
        ...
        <fieldset id="address">
          <div class="heading-title no-border-bottom"><span><?php echo $text_your_address; ?></span></div>
			<div class="multiple-fields-box">  
			  <div class="form-group">
        ...
        <fieldset>
			<div class="heading-title no-border-bottom"><span><?php echo $text_your_password; ?></span></div>
			<div class="multiple-fields-box">
				<div class="form-group required">
        ...
        <fieldset>
			<div class="heading-title no-border-bottom"><span><?php echo $text_newsletter; ?></span></div>
			<div class="multiple-fields-box">	
				<div class="form-group">
...
$('input[name=\'customer_group_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=android_store/register/customfield&customer_group_id=' + this.value,
		dataType: 'json',
...
$('select[name=\'country_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=android_store/account/country&country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
