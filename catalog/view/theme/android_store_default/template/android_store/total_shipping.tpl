...
$('#button-quote').on('click', function() {
	$.ajax({
		url: 'index.php?route=android_store/total_shipping/quote',
		type: 'post',
...
$(document).delegate('#button-shipping', 'click', function() {
	$.ajax({
		url: 'index.php?route=android_store/total_shipping/shipping',
		type: 'post',
...
$('select[name=\'country_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=android_store/total_shipping/country&country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
