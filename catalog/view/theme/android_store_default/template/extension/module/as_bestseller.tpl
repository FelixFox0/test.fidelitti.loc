...
<div id="android-store-bestseller-<?php echo $module; ?>" class="owl-carousel owl-androidstore-module-theme equal-height-columns">
...
$('#android-store-bestseller-<?php echo $module; ?>').owlCarousel({
	items: 4,
	lazyLoad: true,
	lazyEffect: false,	
	pagination: true,
