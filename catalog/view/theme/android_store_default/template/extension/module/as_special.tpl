...
<div id="android-store-special-<?php echo $module; ?>" class="owl-carousel owl-androidstore-module-theme equal-height-columns">
...
$('#android-store-special-<?php echo $module; ?>').owlCarousel({
	items: 4,
	lazyLoad: true,
	lazyEffect: false,
	pagination: true,
