...
<?php } ?>
        ...
        <div class="simplecheckout">
            <?php if (!$cart_empty) { ?>
                <?php if ($steps_count > 1) { ?>
                    ...
                    <?php for ($i=1;$i<=$steps_count;$i++) { ?><div class="simple-step step-step-<?php echo $i; ?>" data-onclick="gotoStep" data-step="<?php echo $i; ?>"><?php echo $step_names[$i-1] ?></div><?php if ($i < $steps_count) ?><?php } ?>
                    </div>
                <?php } ?>
                <?php
                    $replace = array(
            ...
            <div class="large-12 back_to_shopping">
            <a onclick="javascript:history.back(-1); return false;" class="b-back_to_shopping">ПРОДОЛЖИТЬ ШОППИНГ</a>
            
            <?php if ($steps_count > 1) { ?>
                     <div id="simplecheckout_step_menu">
                    <?php for ($i=1;$i<=$steps_count;$i++) { ?><div class="simple-step step-step-<?php echo $i; ?><?php echo $i; ?> simple-step-current" data-onclick="gotoStep" data-step="<?php echo $i; ?>">ЗАКАЗАТЬ</div><?php if ($i < $steps_count) ?><?php } ?>
                    </div>
    ...
    <div class="simplecheckout-button-block buttons" id="buttons">
                    <div class="simplecheckout-button-right">
                            ...
                            <a class="button btn-primary button_oc cart_button btn_order" style="display: block;" data-onclick="createOrder" id="simplecheckout_button_confirm"><?php echo $button_order; ?></a>
                    </div>
                </div> 
    <? } ?>
