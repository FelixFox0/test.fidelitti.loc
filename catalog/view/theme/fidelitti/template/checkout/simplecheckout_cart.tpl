            ...
            <?php foreach ($products as $product) { ?>
                ...
                <div class="cart-product__line-top"></div>
                    ...
                    <div class="total"><?php echo $product['total']; ?></div>
                        ...
                        <div>
                            <div class="product__heart" onclick="wishlist.add('<?php echo $product['product_id']; ?>');">
                                список желаний
                            </div>  
...
function init() {
  ...
  $('#cart__text_help').replaceWith( "<a id='toggler' href='#''>Нужна помощь? +</a><div class='cart__text_help-desc' id='box' style='display: none;'>НАПИСАТЬ НАМ <div><a href='/contact-us/''><img src='/catalog/view/theme/fidelitti/images/send.jpg' alt='' /></a></div>Пожалуйста, отправьте нам email, и мы скоро с Вами свяжемся.</div>" );
