                ...
                <div role="form" id="fastorder">
                    <fieldset>
                        ...
                        <div class="form-group input-group-sm">
                            <input type="text" class="form-control" id="name<?php echo $product_id;?>" name="name<?php echo $product_id;?>" placeholder="<?php echo $text_fastorder_name;?>" required autofocus value="<?php if(isset($username)){echo $username;}?>">
                        </div>
                        <div class="form-group input-group-sm">
                            <input type="tel" class="form-control" id="phone<?php echo $product_id;?>" name="phone<?php echo $product_id;?>" placeholder="<?php echo $text_fastorder_phone;?>" required value="<?php if(isset($telephone)){echo $telephone;}?>">
                        </div>
                        <div class="form-group input-group-sm">
                        ...
                        <div class="form-group button-group-sm">
                        <button style="width: 100%" type="submit" id="btn_submit<?php echo $product_id;?>" class="button-cart btn btn-success btn-lg"><?php echo $text_fastorder_button_submit;?></button>
                        </div>
