 ...
 <?php if (!$cart_empty) { ?>
    <div class="simplecheckout-button-block buttons" id="buttons">
                    ...
                    <?php if ($block_order == 0) { ?>
                        <a class="button btn-primary button_oc btn" data-onclick="nextStep" id="simplecheckout_button_next"><span>Заказать</span></a>
                        <?php } ?>
                        <?php if (!$block_order) { ?>
                            <a class="button btn-primary button_oc btn_order" data-onclick="createOrder" id="simplecheckout_button_confirm"><?php echo $button_order; ?></a>
                        <?php } ?>
                    </div>
                </div> 
    <? } ?>
