...
<div class="bf-panel-wrapper<?php if($isResponsive) : ?> bf-responsive<?php endif; ?> <?php echo $responsivePos; ?> bf-layout-id-<?php echo $layout_id;?>" style="height: 100%;">
    <div class="bf-btn-show"></div>
    <a class="bf-btn-reset" onclick="BrainyFilter.reset();"></a>
    <div class="box bf-check-position <?php if ($isHorizontal) : ?>bf-horizontal<?php endif; ?>" style="height: 100%;">
        ...
        <div class="brainyfilter-panel box-content <?php if ($settings['submission']['hide_panel']) : ?>bf-hide-panel<?php endif; ?>" style="height: 100%;">
            <form class="bf-form 
...
<ul class="accordion" data-accordion data-allow-all-closed="true">
                           ...
                           <div class="accordion-content" data-tab-content>
                                ...
                                <?php else : ?>
                                    ...
                                    if (isset($totals) && isEmptyStock($groupUID, $valueId, $postponedCount, $totals, $selected) && $settings['behaviour']['hide_empty']):
                                        ...
                                        <span class="bf-cell bf-c-1">
                                        <div class="color-filter" id="attr-<?php echo $groupUID . '_' . $valueId . '_' . $layout_id; ?>"></div>
                ...
                <div class="bf-buttonsubmit__block">
...
jQuery(function() {
	...
	$(".bf-buttonsubmit").on("click",function (){
		
		localStorage['Item3'] = '';
		$("input[type='checkbox']:checked").each(function(){
				localStorage['Item3'] += "<div class='filter_check'>"+$("label[for='bf-attr-c0_"+$(this).val()+"_56'],label[for='bf-attr-a12_"+$(this).val()+"_56'],label[for='bf-attr-a14_"+$(this).val()+"_56']").text().trim()+"</div>";
		});
	...
	$('.filter_blocks').prepend(localStorage['Item3']);
