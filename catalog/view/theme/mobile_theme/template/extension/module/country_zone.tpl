<div class="simplecheckout-block" id="simplecheckout_country_zone" <?php echo $display_error && $has_error ? 'data-error="true"' : '' ?>>
    ...
    <div class="simplecheckout-block-content">
        <fieldset class="form-horizontal">
            <div class="form-group required country_block">
                <label class="country_title control-label col-sm-3" for=""><?php echo $entry_country; ?></label>
                <div class="country_select col-sm-9">
            ...
            <div class="form-group required country_block">
                <label class="country_title control-label col-sm-3" for=""><?php echo $entry_zone; ?></label>
                <div class="country_select col-sm-9">
           ...
           <div class="form-group required country_block">
                <label class="country_title control-label col-sm-3" for=""><?php echo $entry_city; ?></label>
                <div class="country_select col-sm-9">
...
jQuery(function(){
    jQuery('#cz_country_id').change(function() {
        jQuery('#cz_zone_id').load('index.php?route=extension/module/country_zone/zone&cz_country_id=' + jQuery(this).val(), function(data){
