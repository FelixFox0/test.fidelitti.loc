	...
	public function index() {
		...
		if ($category_info) {
			...
			if ($category_info['imagetwo']) {
				$data['thumbimagetwo'] = $this->model_tool_image->resize($category_info['imagetwo'], 1200, 400);
			...
			if ($category_info['imagethree']) {
				$data['thumbimagethree'] = $this->model_tool_image->resize($category_info['imagethree'], 1200, 400);
			...
			if ($category_info['productimgone']) {
				$data['thumbproductimgone'] = $this->model_tool_image->resize($category_info['imagethree'], 1200, 400);
			...
			if ($category_info['productImgTwo']) {
				$data['thumbproductImgTwo'] = $this->model_tool_image->resize($category_info['productImgTwo'], 359, 500);
			...
			if ($category_info['productImgThree']) {
				$data['thumbproductImgThree'] = $this->model_tool_image->resize($category_info['productImgThree'], 600, 500);
