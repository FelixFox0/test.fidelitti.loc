...
class ControllerQuickCheckoutCheckout extends Controller { 
	public function index() {
		...
		if (file_exists('/checkout.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/checkout.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('quickcheckout/checkout.tpl', $data));
		}
  	}
