...
class ControllerQuickCheckoutConfirm extends Controller { 
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . 'confirm.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . 'confirm.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('quickcheckout/confirm.tpl', $data));
		}
  	}
}