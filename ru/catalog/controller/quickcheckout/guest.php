...
class ControllerQuickCheckoutGuest extends Controller {
  	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . 'quickcheckout/guest.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . 'quickcheckout/guest.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('quickcheckout/guest.tpl', $data));
		}
  	}
