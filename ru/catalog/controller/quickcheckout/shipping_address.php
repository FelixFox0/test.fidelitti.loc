...
class ControllerQuickCheckoutShippingAddress extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/quickcheckout/shipping_address.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . 'quickcheckout/shipping_address.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('quickcheckout/shipping_address.tpl', $data));
		}
  	}
