...
class ControllerQuickCheckoutVoucher extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . 'voucher.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . 'voucher.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('quickcheckout/voucher.tpl', $data));
		}
	}
