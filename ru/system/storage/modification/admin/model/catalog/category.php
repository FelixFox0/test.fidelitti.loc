...
class ModelCatalogCategory extends Model {
	...
	public function addCategory($data) {
		...
		foreach ($data['category_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "category_description SET category_id = '" . (int)$category_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "', description = '" . $this->db->escape($value['description']) . "', meta_title = '" . $this->db->escape($value['meta_title']) . "', textbuttom = '" . $this->db->escape($value['textbuttom']) . "', linkbuttom = '" . $this->db->escape($value['linkbuttom']) . "', titletwo = '" . $this->db->escape($value['titletwo']) . "', nameimgthree = '" . $this->db->escape($value['nameimgthree']) . "', prodNameImgOne = '" . $this->db->escape($value['prodNameImgOne']) . "', prodDescImgOne = '" . $this->db->escape($value['prodDescImgOne']) . "', prodNameImgTwo = '" . $this->db->escape($value['prodNameImgTwo']) . "', prodDescImgTwo = '" . $this->db->escape($value['prodDescImgTwo']) . "', linkButProdTwo = '" . $this->db->escape($value['linkButProdTwo']) . "', NameButProdTwo = '" . $this->db->escape($value['NameButProdTwo']) . "' , description_two = '" . $this->db->escape($value['description_two']) . "', meta_h1 = '" . $this->db->escape($value['meta_h1']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', meta_keyword = '" . $this->db->escape($value['meta_keyword']) . "'");
		}
	...
	public function editCategory($category_id, $data) {
		...
		foreach ($data['category_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "category_description SET category_id = '" . (int)$category_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "', description = '" . $this->db->escape($value['description']) . "', description_two = '" . $this->db->escape($value['description_two']) . "', meta_title = '" . $this->db->escape($value['meta_title']) . "', textbuttom = '" . $this->db->escape($value['textbuttom']) . "', nameimgthree = '" . $this->db->escape($value['nameimgthree']) . "', prodNameImgOne = '" . $this->db->escape($value['prodNameImgOne']) . "', linkbuttom = '" . $this->db->escape($value['linkbuttom']) . "', titletwo = '" . $this->db->escape($value['titletwo']) . "', prodDescImgOne = '" . $this->db->escape($value['prodDescImgOne']) . "', prodNameImgTwo = '" . $this->db->escape($value['prodNameImgTwo']) . "', prodDescImgTwo = '" . $this->db->escape($value['prodDescImgTwo']) . "', linkButProdTwo = '" . $this->db->escape($value['linkButProdTwo']) . "', NameButProdTwo = '" . $this->db->escape($value['NameButProdTwo']) . "', meta_h1 = '" . $this->db->escape($value['meta_h1']) . "', meta_description = '" . $this->db->escape($value['meta_description']) . "', meta_keyword = '" . $this->db->escape($value['meta_keyword']) . "'");
		}
