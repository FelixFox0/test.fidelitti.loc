...
<div class="row product" id="content">
    ...
    <?php if ($thumb || $images) { ?>
        ...
        <?php if ($images) { ?>
          ...
          <a data-slide-index="<?php echo $i++ ?>" href=""><img src="<?php echo $image['thumb']; ?>" /></a> 
          <?php } ?>
          <?php } ?>
        </div>
        <div class="large-5 columns product__center">
        ...
        <? } ?>
            ...
            <div class="product__desc">
                <ul class="tabs" data-responsive-accordion-tabs="tabs medium-accordion large-tabs" id="example-tabs" role="tablist" data-tabs="j6tnv7-tabs">
                    ...
                    <li class="tabs-title product__tabs-title" role="presentation"><a href="#panel2" role="tab" aria-controls="panel2" aria-selected="true" id="panel2-label">Доставка и возврат</a></li>
                </ul>
