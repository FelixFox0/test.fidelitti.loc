...
class ModelCatalogProduct extends Model {
          ...
          public function saveProductMC($data,$product_id) {
              ...
              if (isset($data['supplier'])&&$data['supplier'])                   $this->db->query("INSERT INTO " . DB_PREFIX . "product_to_supplier SET product_id = '" . (int)$product_id . "', supplier = '" . $data['supplier'] . "'");
              if (isset($data['country_of_origin'])&&$data['country_of_origin']) $this->db->query("INSERT INTO " . DB_PREFIX . "product_country_of_origin SET product_id = '" . (int)$product_id . "', country = '" . $data['country_of_origin'] . "'");
	...
	public function copyProduct($product_id) {
		...
		if ($query->num_rows) {
            ...
            // Module "MultyCurrency Products" v. 2.0 -  copy poduct
               ...
               $data['ym']  = $mquery->row?$mquery->row['ym']:''; 
               ...
               $data['sliv']  = $mquery->row?$mquery->row['sliv']:''; 
