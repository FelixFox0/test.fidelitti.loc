...
class ControllerStartupSeoUrl extends Controller {
	public function index() {
		...
		if (isset($this->request->get['_route_'])) {
            ...
            $this->request->get['news_id'] = $url[1];
					...
					if ($query->row['query'] && $url[0] != 'newsblog_category_id' && $url[0] != 'newsblog_article_id' && $url[0] != 'information_id' && $url[0] != 'news_id' && $url[0] != 'manufacturer_id' && $url[0] != 'category_id' && $url[0] != 'product_id') {
	...
	public function rewrite($link) {
		...
		foreach ($data as $key => $value) {
			if (isset($data['route'])) {
				if (($data['route'] == 'product/product' && $key == 'product_id') || (($data['route'] == 'product/manufacturer/info' || $data['route'] == 'product/product') && $key == 'manufacturer_id') || ($data['route'] == 'newsblog/article' && $key == 'newsblog_article_id') || ($data['route'] == 'information/information' && $key == 'information_id') || ($data['route'] == 'information/news/info' && $key == 'news_id')) {
