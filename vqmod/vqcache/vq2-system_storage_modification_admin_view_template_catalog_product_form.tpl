...
//--></script></div>
      ...
      $(document).ready(function(){
          ...
          add_to_price += '<input type="text" name="country_of_origin" value="<?php echo $country_of_origin; ?>" placeholder="Страна происхождения товара" class="form-control" />';
          ...
          add_to_price += '<input type="text" name="supplier" value="<?php echo $supplier; ?>" placeholder="Поставщик товара" class="form-control" />';
          add_to_price += '</div></div>';
          iPrice.parent().parent().after(add_to_price);   
          ...
          add_to_price += '</div></div>';
          iPrice.parent().parent().after(add_to_price);   
          // Добавляем поле "Закупочная цена"
          add_to_price  = '<div class="form-group"><label class="col-sm-2 control-label" for="input-iprice">Закупочная цена</label><div class="col-sm-10">';
          add_to_price += '<input type="text" name="price_input" value="<?php echo $price_input; ?>" placeholder="Закупочная цена" id="input-iprice" class="form-control" style="width:50%;display:inline-block;" />';
          add_to_price += '<select class="form-control" style="width:50%;display:inline-block;" id="input_currency_id" name="input_currency_id">';
          <?php foreach ($mc_currencies as $curr) { ?>
